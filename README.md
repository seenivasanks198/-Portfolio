...
> *"Architecting high-performance cross-platform mobile apps & responsive web solutions with modern JavaScript, React, and React Native."*

I'm a **results-driven Software Engineer** with **4+ years** of professional experience specializing in building resilient **React Native** mobile applications and modern **React.js** web platforms. Currently at **MitrahSoft Software Solutions**, I engineer scalable cross-platform software across **automotive sales**, **real estate technology**, and **fitness** domains.
...
### 🎯 Key Strengths
- ⚛️ React Native & React.js Cross-Platform Development
- ⚡ High-Performance UI & List Virtualization
- 🔗 Robust REST API Integration & Async State
- 🧩 Modular Component Architecture & Clean Code
- 📱 End-to-End Android Application Lifecycle
...
- 💼 **Current Role:** Software Engineer @ MitrahSoft
- 🎓 **Education:** B.Sc. Computer Science
- 🌐 **Languages:** English, Tamil
- 💡 **Status:** Open for Senior Frontend / RN Roles
...
| Category | Skill | Proficiency | Experience |
|:---------|:------|:------------|:-----------|
| **Frontend** | React.js | `████████████████████░░` 92% | 4 years |
| | TypeScript | `█████████████████░░░░░` 88% | 3 years |
| | JavaScript (ES6+) | `██████████████████░░░░` 94% | 4 years |
| | HTML5 & CSS3 | `███████████████████░░░` 95% | 4 years |
| | Ant Design 5 | `█████████████████░░░░░` 85% | 2 years |
| **Mobile** | React Native | `██████████████████░░░░` 94% | 4 years |
| | React Navigation | `████████████████████░░` 90% | 4 years |
| | FlatList Virtualization | `███████████████████░░░` 96% | 4 years |
| | Android Build & Release | `█████████████████░░░░░` 86% | 3 years |
| **State** | React Hooks & Context | `███████████████████░░░` 95% | 4 years |
| | Zustand & Redux Toolkit | `█████████████████░░░░░` 86% | 3 years |
| **API** | REST API Architecture | `████████████████████░░` 90% | 4 years |
| | Axios & Fetch | `██████████████████░░░░` 92% | 4 years |
...
**Key Highlights:**
- 🏷️ Multi-parameter search & filtering (brand, price, fuel, transmission)
- 📸 Rich detail pages with photo galleries & seller contacts
- ⚡ 60 FPS scrolling across 10,000+ vehicle listings
...
**Key Highlights:**
- 🔍 Dynamic property search by location, budget & amenities
- 🗺️ Interactive maps & agent inquiry forms
- 📱 Mobile-first responsive design
- 📉 **-28% page bounce rate reduction**
...
**Key Highlights:**
- 📊 Interactive BMI & weight loss progress charts
- 🍎 Daily calorie tracker & workout routines
...
**Key Highlights:**
- 🔎 Fast search, sort & filter by budget & locality
- 🧭 Smooth stack navigation & transitions
- 🔄 Real-time property inventory via REST API
...
> Engineered and maintained scalable web & mobile applications using React.js and React Native. Delivered high-impact cross-platform software across automotive, real estate, and wellness industries in an Agile environment.

<details>
<summary><b>🔧 Responsibilities & Achievements</b></summary>

#### Responsibilities
- ⚛️ Architected reusable, high-performance UI components using React Hooks, functional components, and modern CSS/SCSS
- 🔗 Integrated RESTful APIs and managed application state for seamless data flow
- ⚡ Optimized React Native FlatList rendering and image loading, reducing app bundle size and latency
- 👥 Collaborated with cross-functional design, QA, and backend teams in Agile sprints
- 🔍 Led code reviews, performance audits, and Android publishing workflows
- 📦 Maintained Git flow practices across team repositories

#### 🏆 Key Achievements
| Achievement | Impact |
|:------------|:-------|
| Delivered 4+ flagship applications | Inception → Production deployment |
| FlatList rendering optimization | **40% latency reduction** across all RN projects |
| Code quality initiative | **30% fewer post-release bugs** |
| Application reliability | **99.5% crash-free session rates** |

**Tech Used:** `React.js` · `React Native` · `JavaScript ES6+` · `TypeScript` · `REST APIs` · `Git` · `React Navigation` · `FlatList`
...
|:-------|:-----------|:---------|:-----|:------|
| 🎓 **B.Sc. Computer Science** | G. Venkataswamy Naidu College | Kovilpatti, TN | 2016 – 2019 | 70% |
| 📚 HSC (12th Grade) | VOC Higher Secondary School | Kovilpatti, TN | 2015 – 2016 | 78% |
| 📖 SSLC (10th Grade) | VOC High School | Kovilpatti, TN | 2013 – 2014 | 80% |
...
This portfolio is built as a **modern React + Vite** application with an enterprise-grade architecture:
...
├── 📦 src/
│   ├── 📄 App.tsx                # Root app with Ant Design ConfigProvider
│   ├── 📄 main.tsx               # React DOM entry
│   ├── 📂 cms/                   # 📋 CMS-driven portfolio data (JSON)
│   │   ├── portfolio_data.json   # All resume & project data
│   │   └── settings.json         # Site configuration
│   ├── 📂 components/            # 🧩 19 reusable UI components
│   │   ├── Hero.tsx              # Animated hero section
│   │   ├── AboutSection.tsx      # About me details
...
<td>🌍 <b>Multilingual (i18n)</b></td>
<td>⌨️ <b>Command Palette (⌘K)</b></td>
</tr>
<tr>
<td>📋 <b>CMS-Driven Content</b></td>
<td>🎨 <b>Ant Design UI System</b></td>
<td>📱 <b>Fully Responsive</b></td>
</tr>
<tr>
<td>🔍 <b>SEO Optimized</b></td>
<td>🎭 <b>Motion Animations</b></td>
<td>📊 <b>Interactive Skills Charts</b></td>
</tr>
<tr>
<td>✅ <b>Zod Form Validation</b></td>
<td>🔼 <b>Back-to-Top Button</b></td>
<td>📖 <b>Reading Progress Bar</b></td>
</tr>
</table>
...
git clone https://github.com/seenivasanks198/-Portfolio.git
cd -Portfolio
...
<div align="center">
<sub>⭐ Star this repo if you found it inspiring! Built by <b>K. Seenivasan</b></sub>
</div>
